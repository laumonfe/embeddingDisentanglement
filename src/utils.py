...
def load_clipvision_with_projection(model_path, proj_config_path, proj_weights_path):
    """
    Loads a CLIPVisionModel and attaches a visual projection layer.
    """
    import json
    import torch
    import torch.nn as nn
    ...
    # Attach projection layer to vision_model
    vision_model.visual_projection = projection
    return vision_model